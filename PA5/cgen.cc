...
// This function returns a vector of symbols, containing the names of the methods
// defined in the class class_definition.
//
// class_definition is a class definition,

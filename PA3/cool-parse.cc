...
{
       0,   134,   134,   138,   141,   147,   150,   156,   162,   170,
     174,   180
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'{'", "'}'", "';'", "':'", "'+'", "'-'", "'*'", "'/'", "$accept",
  "program", "class_list", "class", "feature_list", "feature", "attribute", YY_NULLPTR
};
...
{
      -1,   -18,     7,    -1,   -22,    -8,   -22,   -22,   -12,   -10,
     -16,   -17,   -21,   -22,   -22,   -10,    -7,   -14,   -22,   -20,
     -19,   -22,   -13,    -9,   -22,   -22,   -22
};
...
{
       8,    18,     1,    11,    11,     5,    23,     6,    18,    17,
      22,    10,    24,    15,    11,    16,    20,    21,    25,     7,
      19,     9,    26
};

static const yytype_int8 yycheck[] =
{
       8,    12,     3,    24,    24,    23,    25,     0,    19,    30,
      30,    23,    31,    29,    24,    32,    23,    31,    31,     3,
      15,    29,    31
};
...
{
       0,     3,    38,    39,    40,    23,     0,    40,     8,    29,
      23,    24,    41,    42,    43,    29,    32,    30,    42,    41,
      23,    31,    30,    25,    31,    31,    31
};
...
#line 157 "cool.y"
    { 
        ...
        features = (yyval.features);
    }
#line 1170 "cool.tab.c"
    break;
...
#line 1179 "cool.tab.c"
    break;

  case 10: /* attribute: OBJECTID ':' TYPEID ';'  */
#line 175 "cool.y"
    { 
        dump_Symbol(cout, 2, (yyvsp[-3].symbol)); 
        dump_Symbol(cout, 2, (yyvsp[-1].symbol)); 
    }
#line 1188 "cool.tab.c"
    break;

  case 11: /* attribute: OBJECTID ':' TYPEID ASSIGN ';'  */
#line 181 "cool.y"
    {
        dump_Symbol(cout, 2, (yyvsp[-4].symbol)); 
        dump_Symbol(cout, 2, (yyvsp[-2].symbol)); 
    }
#line 1197 "cool.tab.c"
    break;


#line 1201 "cool.tab.c"
